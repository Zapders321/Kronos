import os
from indicators import get_full_feature_list
...
class Config:
    ...
    def __init__(self):
        ...
        # Features to be used from the raw data (base OHLCV + technical indicators).
        self.feature_list = get_full_feature_list()
